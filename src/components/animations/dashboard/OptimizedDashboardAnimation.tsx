...
import { standardAnimationVariants } from '../utils/animationUtils';

/**
 * OptimizedDashboardAnimation - A performance-optimized dashboard animation component
 * 
 * This component renders an animated dashboard UI with charts and data points.
 * It uses optimized animation variants and memoization for better performance.
 */
const OptimizedDashboardAnimation: React.FC = React.memo(() => {
  // Motion variants
  const containerVariants = standardAnimationVariants.staggerContainer(0.1);
  const itemVariants = standardAnimationVariants.staggerItem();
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      data-testid="dashboard-animation"
    >
      {/* Header */}
...
OptimizedDashboardAnimation.displayName = 'OptimizedDashboardAnimation';

export default OptimizedDashboardAnimation;
