...
const PerformanceOverview = () => {
  ...
  return (
    <Card className="shadow-sm h-[448px]"> {/* Reduced height by 20% from 560px to 448px */}
      ...
      <CardContent className="pt-0 pb-4 h-[calc(448px-80px)]"> {/* Updated the calculation to use the new height */}
