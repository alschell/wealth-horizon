...
const PerformanceOverview = () => {
  ...
  return (
    <Card className="shadow-sm h-[336px]"> {/* Reduced height by 25% from 448px to 336px */}
      ...
      <CardContent className="pt-0 pb-4 h-[calc(336px-80px)]"> {/* Updated the calculation to use the new height */}
