  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 md:py-32 lg:py-40 pt-24">
        ...
        <HeroScrollButton onScrollToFeatures={onScrollToFeatures} />
      </div>
    </section>
  );
};
...
const HeroContent: React.FC<{
  ...
  scrollToWhyWH: () => void;
  keyFeatures: string[];
}> = ({ scrollToContact, scrollToWhyWH, keyFeatures }) => {
  return (
    <>
...
const HeroScrollButton: React.FC<{ onScrollToFeatures: () => void }> = ({ onScrollToFeatures }) => {
  return (
