...
const LeverageWarning: React.FC<LeverageWarningProps> = memo(({ leverage }) => {
  ...
  return (
    <div className="bg-amber-50 p-4 rounded-md border border-amber-200 mt-6 pointer-events-auto">
      <div className="flex pointer-events-auto">
        <Info className="h-5 w-5 text-amber-600 mr-2 flex-shrink-0 pointer-events-auto" />
