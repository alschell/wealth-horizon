...
import { HelpCircle, Search, FileText, MessageCircle, BookOpen, CheckCircle, ExternalLink, ArrowLeft } from "lucide-react";
          ...
          <>
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <Button variant="outline" className="w-full" onClick={() => setSearchQuery("Getting Started")}>
                        View All Articles
                      </Button>
                    </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <Button variant="outline" className="w-full" onClick={() => setSearchQuery("Platform Features")}>
                        View All Articles
                      </Button>
                    </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <Button variant="outline" className="w-full" onClick={() => setSearchQuery("Account & Billing")}>
                        View All Articles
                      </Button>
                    </div>
                  </div>
            ...
            <section className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <Button variant="outline" className="justify-start h-auto py-4 px-5" asChild onClick={() => navigate("/documentation")}>
            ...
            <Card>
              ...
              <CardFooter className="flex justify-between flex-wrap">
                <div className="text-sm text-gray-500">
                  ...
                  <Button variant="outline" size="sm" className="ml-2">Yes</Button>
