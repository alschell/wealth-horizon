    ...
    <Layout withPadding={false}>
      ...
      <main className="pt-20">
        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] px-6 lg:px-12 animate-fade-in">
          <div className="absolute inset-0 -z-10 h-full w-full bg-gradient-to-b from-gray-50/80 to-gray-100/30 opacity-70"></div>
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
          
          <div className="flex flex-col items-center text-center max-w-5xl">
            <div className="inline-flex items-center justify-center px-4 py-1.5 mb-6 rounded-full bg-gray-100 border border-gray-200">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8 animate-slide-up" style={{ animationDelay: '100ms' }}>
              All your <span className="bg-clip-text text-transparent bg-gradient-to-r from-black to-gray-600">bankable wealth</span> made actionable over <span className="bg-clip-text text-transparent bg-gradient-to-r from-black to-gray-600">one platform</span>
            </h1>
        ...
        <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <div className="inline-flex items-center justify-center px-4 py-1.5 mb-4 rounded-full bg-gray-100 border border-gray-200">
              <span className="text-sm text-gray-700 font-medium">Key Features</span>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-gray-200 border border-gray-300">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-gray-700 mt-0.5 mr-2 flex-shrink-0" />
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    <div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                      <span className="text-gray-700 font-semibold">AI</span>
                    </div>
                  ...
                  <div className="flex items-start">
                    <div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                      <span className="text-gray-700 font-semibold">WP</span>
                    </div>
                    <div className="ml-4 bg-gray-100 rounded-2xl rounded-tl-none p-3">
        ...
        {/* CTA Section */}
        <section className="py-16 bg-gradient-to-b from-gray-50/80 to-white/60">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Features</Button></li>
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Security</Button></li>
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Integrations</Button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">About</Button></li>
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Careers</Button></li>
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Contact</Button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Privacy Policy</Button></li>
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Terms of Service</Button></li>
                <li><Button variant="link" className="p-0 h-auto text-gray-500 hover:text-black">Cookie Policy</Button></li>
              </ul>
            </div>
          </div>
